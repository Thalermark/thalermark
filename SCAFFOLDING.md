...
**Status:** Phases 0–7 shipped (2026-05-23); Phase 8 (MVP features) in progress — slices 8.1–8.5a merged (2026-05-24). Customer + invoice CRUD complete; send-invoice chain started with the public view (email + Stripe still pending in 8.5b/c).
...
| **8** | MVP features — customers + invoices first, then estimates / expenses / dashboard / AI | This is where the product becomes visible | 🚧 In progress (slices 8.1–8.5a, PRs #82–#84, #86, #92, #95, #97–#100 — plus mid-phase footguns #87, #88, #90, #91 and quick-follow fix #96) |
...
**Slice 8.5 — send-invoice chain (in progress):** the first sub-slice ships the public-view side; email send + Stripe pay link are still pending in 8.5b/c.
