...
| **8** | MVP features — customers + invoices first, then estimates / expenses / dashboard / AI / recurring | This is where the product becomes visible | 🚧 In progress, web feature-complete (slices 8.1–8.4f, 8.5a–8.5e, 8.6a–8.6c, 8.7a–8.7e, 8.8a–8.8b, L1–L4, 8.9a–8.9h, 8.10–8.15, R1–R4, PRs #82–#84, #86, #92, #95, #97–#100, #102–#104, #107, #108, #110, #112–#118, #120–#125, #127–#132, #135, #136, #142–#154 — plus mid-phase footguns #87, #88, #90, #91 and quick-follow fix #96) |
...
**Status (2026-06-03):** every item in the list below has shipped on **web** through Phase 8 (slices 8.1–8.15 + L1–L4 + R1–R4). Remaining MVP work is **mobile catch-up** + polish/ship.
