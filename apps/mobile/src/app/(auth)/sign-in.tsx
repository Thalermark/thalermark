    ...
    <SafeAreaView className="flex-1 bg-cream">
      <View className="flex-1 justify-center px-6">
        ...
        <View className="mt-8 gap-5">
          ...
          <View className="items-end">
            <Link href="/forgot-password">
              <Text className="text-sm text-gold-deep underline">Forgot password?</Text>
            </Link>
          </View>
          {error ? (
        ...
        <View className="mt-8 flex-row justify-center">
          ...
          <Link href={invite ? { pathname: '/sign-up', params: { invite } } : '/sign-up'}>
            <Text className="text-sm text-gold-deep underline">Sign up</Text>
          </Link>
        </View>
